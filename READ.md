...
uname -a
```
![image](https://hackmd.io/_uploads/H1kKQAYsp.png)

```bash
lscpu
```
![image](https://hackmd.io/_uploads/rkdG7biop.png)

```bash
nvidia-smi
```
![image](https://hackmd.io/_uploads/SkGafZisp.png)
...
```
![image](https://hackmd.io/_uploads/S1YXIZsoa.png)
...
sudo cmake --install build 
```
![image](https://hackmd.io/_uploads/S1I4-RKjT.png)
...
-p llama-2-chat 
```
![image](https://hackmd.io/_uploads/ryIkN0Fsa.png)
...
```
![image](https://hackmd.io/_uploads/HkzhBCFj6.png)
...
-p llama-2-chat 
```
![image](https://hackmd.io/_uploads/rJlM8Rtip.png)
